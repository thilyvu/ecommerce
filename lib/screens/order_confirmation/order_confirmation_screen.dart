        ...
        children: [
          Stack(
            ...
            Positioned(
              ...
              top: 70,
              child: SvgPicture.asset('assets/svgs/partyFlag.svg', color: Colors.white,
              width: 200,
              height: 150,
              )
            ),
            Positioned(
              ...
              child: Text('Your order is complete!', textAlign: TextAlign.center,
          ...
          Padding(
            ...
            children: [
              ...
              Text('Thank you for purchasing on Unicorn.',
              style: Theme.of(context).textTheme.headline6,),
              const SizedBox(height: 20,),
              Text('ORDER CODE : #k321-edk1',
              style: Theme.of(context).textTheme.headline6,),
              const OrderSummary(),
              const SizedBox(height: 20,),
              Text('ORDER DETAIL',
